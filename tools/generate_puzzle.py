...
FILL_BANK.update({
    ...
    "AVOID": "Steer clear of", "AYE": "Vote in favour", "BATHS": "Roman ones at Bath",
    "BEAN": "Runner or broad", "BEAST": "Beauty's partner", "BEGAN": "Started",
    "BELTS": "Sings out at full volume", "BIG": "Large", "BODY": "Torso and limbs",
    "CAD": "Ungentlemanly fellow", "CARRY": "Bear along", "CASES": "Instances",
    "CHIPS": "Fish's partner", "COD": "Fish in batter", "COL": "Mountain pass",
    "DAD": "Father", "DAIRY": "Milk producer", "DEBUG": "Clear the faults from",
    "DIET": "Eating plan", "DIGIT": "Single numeral", "DISCO": "Club with a glitter ball",
    "DISCS": "Old recordings", "DROVE": "Went by car", "DUAL": "Twofold",
    "EVER": "At any time", "FACED": "Confronted", "FAR": "A long way off",
    "FARMS": "Country holdings", "FIG": "Fruit in a roll", "FLY": "Buzz about",
    "GIFTS": "Presents", "GONNA": "Going to informally", "HANDS": "Applause givers",
    "HILLS": "The ___ are alive", "HOUR": "Sixty minutes", "INTER": "Prefix meaning between",
    "KEEP": "Hold on to", "LOCKS": "Curls of hair", "LOGO": "Brand emblem",
    "LOVE": "What most musicals are about", "MAS": "Mothers informally",
    "NASTY": "Unpleasant", "NEWLY": "Recently", "NICK": "Small cut",
    "NOON": "Midday", "NOT": "In no way", "RACES": "Contests of speed",
    "RALLY": "Come back strongly", "RED": "Annie's hair colour", "RISKS": "Chances taken",
    "ROLLS": "Bread buns", "ROOTS": "Underground parts", "SAFER": "Less risky",
    "SALON": "Hairdresser's", "SIDES": "Flanks", "SIT": "Take a seat",
    "SLOT": "Narrow opening", "SONIC": "Of sound", "SORTS": "Kinds",
    "STACK": "Neat pile", "TAPE": "Old recording format", "TILE": "Roof or floor piece",
    "TIRES": "Grows weary", "TRIPS": "Journeys", "UNDO": "Reverse",
    "WITH": "Alongside", "YEARS": "Twelve-month spans",
    "ACRE": "Field measure", "AND": "Plus", "ARC": "Curved path",
    "BASE": "Bottom support", "BEARS": "Woodland giants", "BET": "Flutter on a horse",
    "BLADE": "Runner or knife edge", "BLAST": "Loud burst", "BONES": "The skeleton",
    "CALLS": "Rings up", "CAROL": "Christmas song", "CAUSE": "Reason for it",
    "CELLS": "Body's building blocks", "CENTS": "Small American coins",
    "CLERK": "Office worker", "CORPS": "Body of troops", "CRAFT": "Skill of the trade",
    "CRIME": "Genre of the caper film", "DELAY": "Hold-up", "DEN": "Cosy back room",
    "DONE": "Finished", "DRIED": "No longer wet", "ELSE": "Otherwise",
    "EMAIL": "Message that arrives instantly", "FIRES": "Blazes",
    "GEM": "Precious stone", "GIRL": "Young lass", "MILES": "Distances travelled",
    "NAVAL": "Of the fleet", "NEAR": "Close by", "NORM": "The usual thing",
    "OMEGA": "Last Greek letter", "OWN": "Have as yours", "READY": "All set",
    "SAME": "Not different", "SAP": "Tree's juice", "SEEKS": "Looks for",
    "SINK": "Kitchen basin", "STOPS": "Comes to a halt", "TONE": "Quality of a sound",
    "TOOLS": "What is in the box", "WHOM": "Formal object of a verb",
    "WIRES": "Cables",
